...
Project title:		.MATE- A Guide to Menstruation
/************************************************************/

/************************************************************/
(0) Build Status

--> Current: Pre-pre-alpha
--> OS:	Windows
...
--> Following program is a mini Menstrual Guide. This program
    ...
    anyone is open to use it as they please.  
    Then there is a Calendar tool, which user can users get 
    their next period. It allows prompts as well, and will guide
    you accordingly. 
...
/************************************************************/
(4) Assembling the Files
    
--> Place Period.h, CalendarIO.h, Menstrual_Guide.h, Log_IO.h
    header files, along with their associated implemenation 
    files (*.cpp) files into one folder. 
--> Next place Menstrual_archive.txt, users.txt and 
    main.cpp in that folder also.

/************************************************************/
(5) Getting Started
--> Please read bullet (11) first.
...
--> When using a terminal:
    ...
    b)Then use "g++ -c *.cpp -o dotMate_Test" then press enter.
    c)Then "./dotMate_Test", hit enter.
    d)Program will execute.
/************************************************************/
...
--> Please use github for collaboration and 
    contact. Feedback, or comments (angry or jolly) is very
    important to me.
...
--> Mr. Denis Laeskar, PhD Sudent, USF
...
How much period does one person has in one lifetim?
